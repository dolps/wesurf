...
public class DetailedAthlete {
  ...
  **/
   ...
   * @return premium
  **/
  @ApiModelProperty(value = "The athlete's premium status.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, resourceState, firstname, lastname, profileMedium, profile, city, state, country, sex, friend, follower, premium, createdAt, updatedAt, followerCount, friendCount, mutualFriendCount, measurementPreference, email, ftp, weight, clubs, bikes, shoes);
  }
