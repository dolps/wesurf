...
import { WesHealthCheckComponent } from '../../../../../../main/webapp/app/admin/health/health.component';
import { WesHealthService } from '../../../../../../main/webapp/app/admin/health/health.service';

describe('Component Tests', () => {

    describe('WesHealthCheckComponent', () => {

        let comp: WesHealthCheckComponent;
        let fixture: ComponentFixture<WesHealthCheckComponent>;
        let service: WesHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [WesurfwebTestModule],
                declarations: [WesHealthCheckComponent],
                providers: [
                    WesHealthService
                ]
            })
            .overrideTemplate(WesHealthCheckComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(WesHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(WesHealthService);
        });
